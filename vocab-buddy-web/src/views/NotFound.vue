        ...
        <div class="list">
          <div class="container toper">
            ...
            <a id="DM_goHomeBtn" target="_blank" style="color: #ff0000;">
              <img src="@/assets/images/logo-main.png" :height="`18px`" style="vertical-align: middle;" alt="favicon">
              继续浏览
          ...
          <div class="container detail">
            ...
            <div class="detail_right">
              <a id="DM_showDetailBtn" target="_blank" :href="child.infoUrl" style="color: #ff0000;">查看详情
                <n-icon :component="TablerArrowBigRight"></n-icon>
              </a>
...
import { pureFetch } from "@/requests"
import { onMounted, reactive, ref } from "vue"
import { message } from "@/utils/NaiveUtil"
import TablerArrowBigRight from "@/assets/icon/tabler/TablerArrowBigRight.vue"
...
const cdnPath = ref("https://cdn.zhaolinlang.com/cdn.dnpw.org/404/res/")

onMounted(() => {
  pureFetch.get("https://api.zhaolinlang.com/get/num/1").then((res) => {
    const data = res["data"][0]
    child["bornDate"] = data["born_date"]
    child["contact"] = data["contact"]
    child["height"] = data["height"]
    child["photoUrl"] = data["md_photo"]
    child["missingAddress"] = data["missing_address"]
    child["missingAge"] = data["missing_age"]
    child["missingDate"] = data["missing_date"]
    child["missingDays"] = data["missing_days"]
    child["missingDescription"] = data["missing_feature"]
    child["name"] = data["name"]
    child["currentAge"] = data["now_age"]
    child["infoUrl"] = data["url"]
    child["sex"] = data["sex"]
  }).catch(() => {
    // console.log(error)

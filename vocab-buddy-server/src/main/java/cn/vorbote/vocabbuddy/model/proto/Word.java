...
public final class Word extends BaseEntity {
     ...
     */
    @Override
    public Word setCreateAt(LocalDateTime createAt) {
     ...
     */
    @Override
    public Word setCreateBy(String createBy) {
     ...
     */
    @Override
    public Word setUpdateAt(LocalDateTime updateAt) {
     ...
     */
    @Override
    public Word setUpdateBy(String updateBy) {
     ...
     */
    @Override
    public Word setArchived(Integer archived) {
